...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_4="tok";
...
//        db.execSQL("CREATE TABLE " + TABLE_NAME + " (ID INTEGER,ip TEXT,db TEXT,user TEXT,pass TEXT)");
        db.execSQL("CREATE TABLE " + TABLE_NAME + " (ID TEXT,name TEXT,pass TEXT,token TEXT)");
    ...
    public boolean insertData (String name, String userid,String token) {
